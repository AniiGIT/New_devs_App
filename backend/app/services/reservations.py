...
async def calculate_monthly_revenue(property_id: str, month: int, year: int, timezone: str = "UTC", db_session=None) -> Decimal:
    """
    Calculates revenue for a specific month, accounting for the property's timezone.
    """
    ...
    print(f"DEBUG: Querying {property_id} (tz={timezone}) " f"from {start_utc} to {end_utc}")
